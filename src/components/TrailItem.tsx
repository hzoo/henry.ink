			...
			<div className="flex items-start justify-between mb-2">
				<div className="flex-grow">
					<button
						...
						className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium text-sm leading-tight hover:underline text-left flex items-center gap-1"
					>
						{trail.name === "Inbox" && <span className="text-xs">📥</span>}
						{trail.name}
						{trail.name === "Inbox" && (
							<span className="ml-1 px-1.5 py-0.5 text-xs font-medium bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full">
								Default
							</span>
						)}
					</button>
