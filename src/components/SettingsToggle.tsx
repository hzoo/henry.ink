...
import { lastSeenVersion } from "@/src/lib/extension-signals";
				...
				<div
					...
					title={
						autoFetchEnabled.value
							? "Auto-fetch enabled - Posts are automatically loaded"
							: "Auto-fetch disabled - Manual refresh only"
					}
				>
					{autoFetchEnabled.value && (
