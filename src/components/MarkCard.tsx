...
export function MarkCard({ mark, onClick }: MarkCardProps) {
  ...
  return (
    <div 
      className="col-span-1 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden bg-white dark:bg-gray-800 hover:border-gray-300 dark:hover:border-gray-600 transition-colors cursor-pointer group h-fit"
      onClick={handleClick}
      title={mark.note || title}
    >
      {/* Note at top with purple styling - consistent with strongRef cards */}
      {mark.note && (
        <div className="px-3 py-2 bg-purple-50 dark:bg-purple-900/10 border-b border-purple-100 dark:border-purple-800/30">
