  ...
  const handleLikeClick = async (e: MouseEvent) => {
    ...
    try {
        if (currentLikeUri) {
            ...
            findAndUpdatePostInSignal(threadSignal, post.uri, (p: AppBskyFeedDefs.PostView) => ({
                  ...p,
        ...
        batch(() => {
          ...
          actionError.value = error instanceof Error ? error.message : "Failed to update like status.";
        });
    } finally {
    ...
    try {
        ...
        console.error("Failed to repost/delete repost:", error);
         batch(() => {
             ...
             actionError.value = error instanceof Error ? error.message : "Failed to update repost status.";
         });
    } finally {
