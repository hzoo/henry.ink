		...
		<div class="sticky top-0 z-10 p-3 bg-white/80 dark:bg-gray-900/80 backdrop-blur border-b border-gray-200 dark:border-gray-800">
			<div class="flex items-center justify-between">
					...
					<div class="flex flex-col">
						...
						{autoFetchEnabled.value ? (
							isWhitelisted.value && currentDomain.value && (
								<div class="flex items-center text-xs mt-0.5 gap-1">
				...
				<div class="flex items-center gap-2">
					<button
						onClick={toggleTheme}
						class="p-1.5 rounded-full text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-700"
