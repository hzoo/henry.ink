...
const SelectionPopup = ({ visible, position }: SelectionPopupProps) => {
  ...
  return (
    <div
      className="absolute z-50 flex items-center gap-1 rounded-lg border border-gray-300 p-1 bg-white shadow-xl whitespace-nowrap min-w-max 
    ...
    >
      <button className="inline-flex flex-shrink-0 items-center gap-1 rounded px-1.5 py-0.5 text-sm text-gray-700 hover:bg-gray-100 
