...
const sampleUrls = [
	...
	{ name: "Hope in Source podcast", url: "https://hopeinsource.com" },
    { name: "MDN (Blocked)", url: "https://developer.mozilla.org/" },
];
...
export function App() {
	...
	return (
		<div class="flex flex-col h-screen bg-gradient-to-br from-slate-50 to-stone-100 dark:from-slate-900 dark:to-gray-900 text-gray-900 dark:text-gray-100 font-sans">
			{/* Cozy/Lofi Header */}
			<header class="px-4 py-3 border-b border-slate-200 dark:border-gray-700 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm text-center">
			...
			<div class="flex flex-1 overflow-hidden">
				<main class="flex-1 flex flex-col p-3 gap-3">
					...
					<div class="flex flex-wrap gap-2 items-center text-sm">
						<span class="text-gray-600 dark:text-gray-400">Try:</span>
